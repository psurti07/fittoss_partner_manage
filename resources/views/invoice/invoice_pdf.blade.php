    ...
    <div class="tm_container">
        <div class="tm_invoice_wrap">
            <div class="tm_invoice tm_style2 tm_type1 tm_accent_border tm_radius_0 tm_small_border" id="tm_download_section">
                ...
                <div style="padding-top: 15px;border-bottom: none;padding-top: 15px;border-bottom: none;margin-bottom: 20px;position: relative;z-index: 100;">
                    <div class="">
                        <div class="">
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px;width:30%;">
                                            <div style="position: relative;z-index: 2;width: 171px;">
                                                <img src="data:image/png;base64,{{ base64_encode(file_get_contents("https://fittoss.com/public/storage/images/logo/fittoss-logo.png")) }}" alt="Fittoss" />
                                            </div>
                                            {{-- <div style="position: absolute;height: 100%;width: 37%;-webkit-transform: skewX(-35deg);transform: skewX(-35deg);top: 0px;left: -100px;border-color: #e4d8ff;background-color: rgb(242 238 251);border: 1px solid #e4d8ff;"></div> --}}
                                        </td>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px; width:70%;">
                                            <div class="tm_f14">
                    ...
                    <div class="">
                        <div class="">
                            <table>
                                <tbody>
                                    <tr>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px;"><b class="tm_primary_color">Invoice No: </b>{{ $invoice->inv_prefix.$invoice->inv_number }}</td>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px;"><b class="tm_primary_color">Mobile: </b> {{ config('constant.COMPANY_MOBILE') }}</td>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px;"><b class="tm_primary_color">CIN No: </b> {{ config('constant.CIN_NUMBER') }}</td>
                                    </tr>
                                    <tr>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px;"><b class="tm_primary_color">Invoice Date: </b>{{ displayDate($invoice->inv_date) }}</td>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px;"><b class="tm_primary_color">Email: </b> {{ config('constant.COMPANY_INFO_EMAIL') }}</td>
                                        <td style="border-top: 0;border-left: 0px;padding: 0px;font-size: 14px;"><b class="tm_primary_color">GST No: </b> {{ config('constant.GST_NUMBER') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <h2 class="tm_f16 tm_section_heading tm_accent_border_20 tm_mb0">
                    <span class="tm_width_3 tm_bold tm_border_top_0 tm_accent_bg_10 tm_radius_0 tm_curve_35 tm_border tm_accent_border_20 tm_border_bottom_0 tm_accent_color tm_f14 tm_semi_bold"><span>Invoice To</span></span>
                </h2>
                <div class="tm_table tm_style1 tm_mb30">
                    <div class="tm_border tm_accent_border_20 tm_border_top_0">
                        <div class="tm_table_responsive">
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="tm_width_6 tm_border_top_0 tm_f14"><b class="tm_primary_color">Name: </b>{{ $user->first_name .' '.$user->last_name }}</td>
                                        <td class="tm_width_6 tm_border_top_0 tm_border_left tm_accent_border_20 tm_f14"><b class="tm_primary_color">Phone: </b> {{ $user->mobile_no }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tm_width_6 tm_accent_border_20 tm_f14"><b class="tm_primary_color">Email: </b>{{ $user->email }}</td>
                                        <td class="tm_width_6 tm_border_left tm_accent_border_20 tm_f14"><b class="tm_primary_color">Address: </b>{{ $user->city != '' || $user->city != null ? $user->city : 'N/A' }},{{ $user->state != '' || $user->state != null ? $user->state : 'N/A' }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="tm_border tm_accent_border_20">
                        <div class="tm_table_responsive">
                            <table>
                                <thead>
                                    <tr>
                                        <th class="tm_width_3 tm_bold tm_f16 tm_border_top_0 tm_accent_color tm_accent_bg_10 tm_f14">Program</th>
                                        <th class="tm_width_3 tm_bold tm_f16 tm_border_top_0 tm_accent_color tm_accent_bg_10 tm_text_right tm_f14">Amount(Rs)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="tm_width_2 tm_accent_border_20 tm_f14">{{ $user->product->productname }}</td>
                                        <td class="tm_width_2 tm_accent_border_20 tm_text_right tm_f14">Rs. {{ number_format($invoice->inv_price, 2) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="tm_invoice_footer tm_mb15 tm_m0_md">
                        <div class="tm_right_footer">
                            <table class="tm_mb15 tm_m0_md">
                                <tbody>
                                    <tr>
                                        <td class="tm_width_3 tm_primary_color tm_border_none tm_f14">Subtotal</td>
                                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_f14">Rs. {{ number_format($invoice->inv_price, 2) }}</td>
                                    </tr>
                                    @if($invoice->inv_cgst > 0)
                                    <tr>
                                        <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0 tm_f14">+ 9% CGST</td>
                                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_f14 tm_pt0">Rs. {{ number_format($invoice->inv_cgst, 2) }}</td>
                                    </tr>
                                    @endif
                                    @if($invoice->inv_sgst > 0)
                                    <tr>
                                        <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0 tm_f14">+ 9% SGST</td>
                                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_f14 tm_pt0">Rs. {{ number_format($invoice->inv_sgst, 2) }}</td>
                                    </tr>
                                    @endif
                                    @if($invoice->inv_igst > 0)
                                    <tr>
                                        <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0 tm_f14">+ 18% IGST</td>
                                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_f14 tm_pt0">Rs. {{ number_format($invoice->inv_grandtotal, 2) }}</td>
                                    </tr>
                                    @endif
                                    <tr class="tm_accent_border_20 tm_border">
                                        ...
                                        <td class="tm_width_3 tm_bold tm_f16 tm_border_top_0 tm_accent_color tm_text_right tm_accent_bg_10">Rs. {{ number_format($invoice->inv_grandtotal, 2) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
