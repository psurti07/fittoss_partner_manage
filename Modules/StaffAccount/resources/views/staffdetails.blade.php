...
<div class="container-fluid">
    <div class="row g-3">
        @if($staffDetails->is_active == 0)
        <div class="col-md-12 col-xs-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <p><strong>Staff account is not activated.</strong> You can activate user account from action panel.</p>
            </div>
        </div>
        @endif
        <div class="col-md-12 col-xs-12">
                            ...
                            <form action="{{ route('manage.staff.account.update') }}" method="post" class="staff-update-form" id="staff-update-form">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Position" id="position" name="position" value="{{ $staffDetails->position }}">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-border logs-list-table" style="width:100%" id="logs-list-table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Date</th>
                        ...
                        <div class="tab-pane fade" id="pills-warning-actions" role="tabpanel" aria-labelledby="pills-warning-actions-tab">
                            <form class="row g-3 needs-validation custom-input update-password-form" id="update-password-form" novalidate="" method="post" action="{{ route('manage.staff.account.update.password') }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="password" class="form-control " id="new_password" name="new_password" placeholder="New Password" required="" autocomplete="new-password">
                                    @component('components.ajax-error',['field'=>'new_password'])@endcomponent
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label" for="retype_password">Retype Password <span class="text-danger">*</span></label>
                                    <input type="password" class="form-control" id="retype_password" name="retype_password" placeholder="Retype Password" required="" autocomplete="retype-password">
                            ...
                            <div class="row text-center m-t-40 g-3">
                                ...
                                <div class="col-md-6 text-lg-end">
                                    <button class="btn btn-outline-warning accBtn" id="deactive-btn" onclick="deactivate({{ $staffDetails->id }},0)">DEACTIVATE STAFF ACCOUNT</button>
                                </div>
