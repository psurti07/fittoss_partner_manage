            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="eventLeadsTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('#eventLeadsTable').DataTable({
            responsive:true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('manage.events.leads') }}",
                data: function (d) {
    ...
    function openInfoModal(infoId){
        $.ajax({
            url: "{!! route('manage.events.leads.info') !!}",
            type: 'POST',
