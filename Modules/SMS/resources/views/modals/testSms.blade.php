                        ...
                        <div class="form-group col-md-12 mb-3">
                            ...
                            <div class="form-check-size rtl-input">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input me-2" id="inlineRadio1" type="radio" name="senderid" value="FITTOS" checked="">
                                    <label class="form-check-label" for="inlineRadio1">FITTOS</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input me-2" id="inlineRadio2" type="radio" name="senderid" value="FITSWL">
                                    <label class="form-check-label" for="inlineRadio2">FITSWL</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input me-2" id="inlineRadio3" type="radio" name="senderid" value="FITOSW">
                                    <label class="form-check-label" for="inlineRadio3">FITOSW</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input me-2" id="inlineRadio4" type="radio" name="senderid" value="FTTOSS">
                                    <label class="form-check-label" for="inlineRadio4">FTTOSS</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-12 mb-3">
