...
@section('breadcrumb-title')
    <h3>Resigning List</h3>
@endsection


@section('breadcrumb-items')
    <li class="breadcrumb-item active">Resigning List</li>
@endsection
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            $('#dateBtn').on('click', function () {
                ...
                window.LaravelDataTables['resignemployee-table'].ajax.url('{{ route('manage.resigning-list.index') }}?month_id=' + selectedMonth).load();
            });
        });
