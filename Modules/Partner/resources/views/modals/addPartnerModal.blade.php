<div class="modal fade" id="addPartner" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="{{route('manage.partner.store')}}" class="save-channel-partner-form" id="save-channel-partner-form" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label for="company_gst_no">GST No<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="company_gst_no" id="company_gst_no" value="{{ old('company_gst_no') }}" placeholder="GST No"/>
                            @component('components.ajax-error',['field'=>'company_gst_no'])@endcomponent
                        </div>
                        <div class="col-md-8">
...
<script>
    $(document).ready(function(){
        const partnerDetailsUrl = @json(route('manage.partner.details', ['id' => '__ID__']));
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.type === 'SUCCESS') {
                            ...
                            let redirectUrl = partnerDetailsUrl.replace('__ID__', result.data);
