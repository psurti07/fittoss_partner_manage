                            ...
                            <form action="{{ route('manage.partner.companyinfo.update') }}" method="post" id="company-update-form">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <h6 class="fw-normal">Company URL: {{ $company->company_code }}</h6>
                                    </div>
                                    <hr />
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="descriptions" id="descriptions" value="{{ $company->descriptions }}" placeholder="Descriptions" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea class="form-control" rows="2" name="company_address" id="company_address">{{ $company->company_address }}</textarea>
                        ...
                        <div class="tab-pane fade" id="ver-pills-actions" role="tabpanel" aria-labelledby="ver-pills-actions-tab">
                            ...
                            <div class="row text-center m-t-40 g-3">
                                ...
                                <div class="col-md-6 text-lg-end">
                                    <button class="btn btn-outline-warning accBtn" id="deactive-btn" onclick="deactivate({{ $company->id }},0)">DEACTIVATE PARTNER
                                        ACCOUNT</button>
                                </div>
                                ...
                                <div class="col-md-6 text-center">
                                    <button class="btn btn-outline-success accBtn" id="activate-btn" onclick="deactivate({{ $company->id }},1)">ACTIVATE PARTNER
                                        ACCOUNT</button>
                                </div>
                                @endif
                            </div>
