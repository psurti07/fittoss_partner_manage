            ...
            <ul class="nav flex-column nav-pills nav-success" id="ver-pills-tab" role="tablist" aria-orientation="vertical">
                <li class="nav-item">
                    <a class="nav-link active" id="ver-pills-customerInfo-tab" data-bs-toggle="pill" href="#ver-pills-customerInfo" role="tab" aria-controls="ver-pills-customerInfo" aria-selected="true">
                        <i class="icofont icofont-business-man-alt-1"></i>Partner Info
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="ver-pills-companyInfo-tab" data-bs-toggle="pill" href="#ver-pills-companyInfo" role="tab" aria-controls="ver-pills-companyInfo" aria-selected="true">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="ver-pills-actions-tab" data-bs-toggle="pill" href="#ver-pills-actions" role="tab" aria-controls="ver-pills-actions" aria-selected="true">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content" id="ver-pills-tabContent">
                            ...
                            <form action="{{ route('manage.partner.personalinfo.update') }}" method="post" id="partner-update-personal-form">
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" name="dob" id="dob" value="{{ $partner->dob }}" placeholder="DOB" />
                                        @component('components.ajax-error', ['field' => 'dob'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="address">Address</label>
                                        <textarea class="form-control" rows="2" name="address" id="address" placeholder="Address">{{ $partner->address }}</textarea>
                                    ...
                                    {{-- <div class="col-md-4">
                                        ...
                                        <div class="d-flex d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="is_active" id="active" value="1" {{ old('is_active', $partner->is_active ?? 1) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="is_active" id="inactive" value="0" {{ ($partner->is_active == 0) ? "checked" : "" }}>
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="form-group col-md-4">
                                        <img src="{{ $partner->image_url ?? "" }}" width="120px" id="imgpreview" class="mt-3">
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="ver-pills-companyInfo" role="tabpanel" aria-labelledby="ver-pills-companyInfo-tab">
                            <form action="{{ route('manage.partner.companyinfo.update') }}" method="post" id="company-update-form">
                                <input type="hidden" name="company_id" value="{{ $partner->company->id }}">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <h6 class="fw-normal">Company Code: <b>{{ $partner->company->company_code }}</b>
                                        </h6>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="company_name">Company Name<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="company_name" id="company_name" value="{{ $partner->company->company_name }}" placeholder="Company Name" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="tel" class="form-control numeric-input" name="company_mobile_no" maxlength="10" minlength="10" id="company_mobile_no" value="{{ $partner->company->company_mobile_no }}" placeholder="Company Mobile" />
                                        @component('components.ajax-error', ['field' => 'company_mobile_no'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="project_name">Project Name<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="project_name" id="project_name" value="{{ $partner->company->project_name }}" placeholder="Project Name" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" name="register_date" id="register_date" value="{{ $partner->company->register_date }}" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" name="company_live_date" id="company_live_date" value="{{ $partner->company->company_live_date }}" placeholder="Website Live" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="url" class="form-control" name="website_url" id="website_url" value="{{ $partner->company->website_url }}" placeholder="Company Website URL" />
                                        @component('components.ajax-error', ['field' => 'website_url'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="company_email">Company Email<span class="text-danger">*</span></label>
                                        <input type="company_email" class="form-control" name="company_email" id="company_email" value="{{ $partner->company->company_email }}" placeholder="Email" autocomplete="off" />
                                        @component('components.ajax-error', ['field' => 'company_email'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="company_gst_no">Company GST No<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="company_gst_no" id="company_gst_no" value="{{ $partner->company->company_gst_no }}" placeholder="GST No" />
                                        @component('components.ajax-error', ['field' => 'company_gst_no'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="company_fssai">Company FSSAI<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="company_fssai" id="company_fssai" value="{{ $partner->company->company_fssai }}" placeholder="FSSAI" />
                                        @component('components.ajax-error', ['field' => 'company_fssai'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="city">City<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="city" id="city" value="{{ $partner->company->city }}" placeholder="City"/>
                                        @component('components.ajax-error',['field'=>'city'])@endcomponent
                                    </div>                                    
                                    <div class="col-md-4">
                                        <label for="pincode">Pincode<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control numeric-input" name="pincode" id="pincode" value="{{ $partner->company->pincode }}" placeholder="Pincode" maxlength="6" minlength="6"/>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" name="state" id="state">
                                            ...
                                            {!! getStateOption($partner->company->state) !!}
                                        </select>
                                    ...
                                    {{-- <div class="col-md-4">
                                        ...
                                        <div class="d-flex d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="company_status" id="company_active" value="1" {{ old('company_status', $partner->company->is_active ?? 1) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="company_status" id="company_inactive" value="0" {{ ($partner->company->is_active == 0) ? "checked" : "" }}>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="d-flex d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="is_verified" id="yes" value="1" {{ old('is_verified', $partner->company->is_verified ?? 1) == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="is_verified" id="no" value="0" {{ ($partner->company->is_verified == 0) ? "checked" : "" }}>
                                                <label class="form-check-label" for="no">
                                                    No
                                                </label>
                                            </div>
                                        </div>
                                        @component('components.ajax-error', ['field' => 'is_verified'])
                                        @endcomponent
                                    </div> --}}
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="company_type" name="company_type">
                                            ...
                                            <option value="Sole-Proprietor" {{ $partner->company->company_type == 'Sole-Proprietor' ? 'selected' : '' }}>
                                                Sole-Proprietor</option>
                                            <option value="Proprietor" {{ $partner->company->company_type == 'Proprietor' ? 'selected' : '' }}>
                                                Proprietor</option>
                                            <option value="Private Limited" {{ $partner->company->company_type == 'Private Limited' ? 'selected' : '' }}>
                                                Private Limited</option>
                                            <option value="Limited" {{ $partner->company->company_type == 'Limited' ? 'selected' : '' }}>Limited
                                            </option>
                                            <option value="LLP" {{ $partner->company->company_type == 'LLP' ? 'selected' : '' }}>Limited
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea class="form-control" rows="2" name="company_address" id="company_address">{{ $partner->company->company_address }}</textarea>
                                    ...
                                    <div class="row g-3 mt-2">
                                        ...
                                        <div class="form-group col-md-4">
                                            <img src="{{ $partner->company->logo_url ?? "" }}" width="120px" id="logopreview" class="mt-3">
                                        </div>
                                    </div>
                                    <div class="row g-3 mt-2">
                                        <div class="col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            <img src="{{ $partner->company->icon_url ?? "" }}" width="120px" id="iconPreview" class="mt-3">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3 text-end">
                            ...
                            <form action="{{ route('manage.partner.socialinfo.update') }}" method="post" id="social-update-form">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="facebook_url" id="facebook_url" value="{{ $partner->company->facebook_url }}" />
                                        @component('components.ajax-error', ['field' => 'facebook_url'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="instagram_url">Instagram URL</label>
                                        <input type="tel" class="form-control numeric-input" name="instagram_url" maxlength="10" minlength="10" id="instagram_url" value="{{ $partner->company->instagram_url }}" />
                                        @component('components.ajax-error', ['field' => 'instagram_url'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="twitter_url">Twitter URL</label>
                                        <input type="text" class="form-control" name="twitter_url" id="twitter_url" value="{{ $partner->company->twitter_url }}" />
                                        @component('components.ajax-error', ['field' => 'twitter_url'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="linkedin_url">Linkedin URL</label>
                                        <input type="text" class="form-control" name="linkedin_url" id="linkedin_url" value="{{ $partner->company->linkedin_url }}" />
                                        @component('components.ajax-error', ['field' => 'linkedin_url'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="pinterest_url">Pinterest URL</label>
                                        <input type="text" class="form-control" name="pinterest_url" id="pinterest_url" value="{{ $partner->company->pinterest_url }}" />
                                        @component('components.ajax-error', ['field' => 'pinterest_url'])
                                        @endcomponent
                                    </div>
                                    <div class="col-md-4">
                                        <label for="youtube_url">Youtube URL</label>
                                        <input type="text" class="form-control" name="youtube_url" id="youtube_url" value="{{ $partner->company->youtube_url }}" />
                        ...
                        <div class="tab-pane fade" id="ver-pills-actions" role="tabpanel" aria-labelledby="ver-pills-actions-tab">
                            ...
                            <div class="row text-center m-t-40 g-3">
                                ...
                                <div class="col-md-6 text-lg-end">
                                    <button class="btn btn-outline-warning accBtn" id="deactive-btn" onclick="deactivate({{ $partner->id }},0)">DEACTIVATE PARTNER
                                        ACCOUNT</button>
                                </div>
                                <div class="col-md-6 text-lg-start">
                                    <button class="btn btn-outline-danger" id="delete-btn" onclick="destroy({{ $partner->id }})">DELETE PARTNER</button>
                                </div>
                                @else
                                <div class="col-md-6 text-center">
                                    <button class="btn btn-outline-success accBtn" id="activate-btn" onclick="deactivate({{ $partner->id }},1)">ACTIVATE PARTNER
                                        ACCOUNT</button>
                                </div>
                                @endif
                            </div>
...
<script>
    ...
    function deactivate(partner_id, status) {
