            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="smsSettingTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Update Date</th>
...
<div class="addModals">
    @include('siteoptions::sms.modals.edit')
</div>
@endsection
...
<script>
    ...
    var table = $('#smsSettingTable').DataTable({
        responsive: true
        , processing: true
        , serverSide: true
        , ajax: {
            url: "{{ route('manage.sms-setting.index') }}"
            , data: function(d) {
        ...
        , columns: [{
            ...
            , {
                data: 'remarketing_sender_id'
                , name: 'ss.remarketing_sender_id'
            }
            , {
                data: 'action'
                , name: 'action'
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const modalEl = document.getElementById("editSmsSetting");
        const form = document.querySelector("#updateSmsSettingForm");
        ...
        form.addEventListener("submit", async (e) => {
            ...
            try {
                ...
                const res = await fetch("{{ route('manage.sms-setting.update') }}", {
                    method: "POST"
                    , headers: {
                        "X-CSRF-TOKEN": csrf
