        ...
        <div class="row g-3">
            <div class="col-12">
                <form method="post" class="needs-validation welcome-message-form" novalidate="" action="{{route('manage.welcome-message.update')}}">
                    <input type="hidden" value="welcome-message" name="name">
                    <div class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="form-group col-md-6">
                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                <input type="radio" class="btn-check" name="status" id="btnradio1" autocomplete="off" value="1" {{ $data->status == 1 ? 'checked' : '' }}>
                                <label class="btn btn-outline-info" for="btnradio1">Show</label>
                                <input type="radio" class="btn-check" name="status" id="btnradio2" autocomplete="off" value="0" {{ $data->status == 0 ? 'checked' : '' }}>
...
@endpush
@push('script-tag')
    @include('stacks.js.siteoptions.welcomemessage')
@endpush
