...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active"> Customer Account Message</li>
@endsection
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        @component('components.ajax-error',['field'=>'accountmessage_self_apply'])@endcomponent
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        @component('components.ajax-error',['field'=>'accountmessage_loan_agent'])@endcomponent
                                    </div>
                                </div>
                            </div>
                        </div>
...
@endpush
@push('script-tag')
    @include('stacks.js.siteoptions.accountmessage')
@endpush
