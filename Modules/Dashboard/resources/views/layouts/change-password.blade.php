                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation custom-input update-password-form" id="update-password-form" novalidate="" method="post" action="{{ route('manage.updatePassword') }}">
                            ...
                            <div class="form-footer">
                                <button type="submit" class="btn btn-primary" id="changePasswordBtn" name="changePasswordBtn">Change Password</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        $('.update-password-form').submit(function (event) {
            ...
            if (status) {
                ...
                $.ajax({
                    ...
                    contentType: false,
                    beforeSend: function(){
                        $('#changePasswordBtn').html('<span class="spinner-border spinner-border-sm"></span> Changing...');
