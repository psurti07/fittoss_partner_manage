            ...
            <div class="col-md-4 ms-auto">
                <div class="d-flex gap-2">
                    <div>
                        ...
                        <button type="button" id="uploadBtn" class="btn btn-sm btn-outline-danger">
                            <i class="fa fa-upload"></i> Upload Data
                        </button>
                        <span id="fileName" class="ms-2 text-muted small"></span>
                    </div>
                    <div>
                        <a href="{{ asset('assets/csv/dndfile-sample.csv') }}" target="_blank"
                            class="btn btn-sm btn-outline-primary" id="downloadBtn">
        ...
        $(document).ready(function() {
            ...
            $('#csvFile').change(function() {
                ...
                if (fileName) {
                    ...
                    $('#fileName').text('No file chosen').removeClass('text-primary').addClass(
                        'text-muted');
                }
            });
