            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="childNutritionOfferCustomerTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('#childNutritionOfferCustomerTable').DataTable({
            responsive:true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('manage.child-nutrition-offer.customers') }}",
                data: function (d) {
