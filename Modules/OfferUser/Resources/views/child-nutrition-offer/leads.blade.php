            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="childNutritionOfferLeadTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('#childNutritionOfferLeadTable').DataTable({
            responsive:true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('manage.child-nutrition-offer.leads') }}",
                data: function (d) {
