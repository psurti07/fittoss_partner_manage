...
@section('title', 'Weight Loss Program Customers')
...
<h3>Weight Loss Program Customers</h3>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="weightLossProgramCustomerTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('#weightLossProgramCustomerTable').DataTable({
            responsive:true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('manage.weight-loss-program.customers') }}",
                data: function (d) {
