...
@section('title', 'Bodyfat Analysis Workshop Leads')
...
<h3>Bodyfat Analysis Workshop Leads</h3>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="BFAWLeadsTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('#BFAWLeadsTable').DataTable({
            responsive:true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('manage.bodyfat-analysis-workshop.leads') }}",
                data: function (d) {
    ...
    function openInfoModal(infoId){
        $.ajax({
            url: "{!! route('manage.bodyfat-analysis-workshop.leads.info') !!}",
            type: 'POST',
