...
@section('title', 'Bodyfat Analysis Workshop Customers')
...
<h3>Bodyfat Analysis Workshop Customers</h3>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="BFAWCustomersTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('#BFAWCustomersTable').DataTable({
            responsive:true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('manage.bodyfat-analysis-workshop.customers') }}",
                data: function (d) {
