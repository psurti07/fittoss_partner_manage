...
<h3>Weight Loss Webinar Leads</h3>
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="WLWLeadsTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Date</th>
...
<script type="text/javascript">
    ...
    $(function () {
        var table = $('#WLWLeadsTable').DataTable({
            responsive:true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('manage.weight-loss-webinar.leads') }}",
                data: function (d) {
    ...
    function openInfoModal(infoId){
        $.ajax({
            url: "{!! route('manage.weight-loss-webinar.leads.info') !!}",
            type: 'POST',
