...
class OnboardUPICustomerDataTable extends DataTable
{
    /**
    ...
    public function query(Customer $model): QueryBuilder
    {
        return $model->newQuery()
            ->paid()
            ->where('is_delete', 0)
            ->where('product_id', config('constant.ONBOARD_UPI_PAYMENT_OFFER_ID'));
    }
    ...
    {
        return $this->builder()
            ->setTableId('onboardUPICustomerTable')
    ...
    {
        return 'OnboardUPICustomer_' . date('YmdHis');
    }
}
