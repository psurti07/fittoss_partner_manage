...
class DndListDataTable extends DataTable
{
    ...
    public function query(Customer $model): QueryBuilder
    {
        ...
        //$query = $model->newQuery()->select('id', 'first_name', 'last_name', 'mobile')->where(['is_dnd' => 1, 'company_code' => $type, 'is_active' => 1, 'is_delete' => 0])->orderBy('id');
        $query = $model->newQuery()->select('id', 'first_name', 'last_name', 'mobile_no')->where(['is_dnd' => 1, 'is_active' => 1, 'is_delete' => 0])->orderBy('id');
